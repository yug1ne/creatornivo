...
| Medium | ESLint warnings | `src/app/api/admin/templates/route.ts`, `src/components/library/library-grid.tsx` | Full ESLint reports existing unused-variable warnings. | Clean up warnings when addressing lint gate. |
