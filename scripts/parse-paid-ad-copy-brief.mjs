/**
 * Parse Paid Ad Copy brief into schema JSON.
 * Usage: node scripts/parse-paid-ad-copy-brief.mjs [path-to-brief.txt]
 */
...
const briefPath =
  ...
  path.join(
    ...
    ".grok/sessions/F%3A%5Ccreatornivo/019f505d-6680-70f1-adb8-cb5fadaff5be/prompts/prompt_36.txt",
  );
...
const out = path.join(root, "agent-tools", "paid-ad-copy-schema-parsed.json");
