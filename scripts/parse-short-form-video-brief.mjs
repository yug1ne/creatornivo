/**
 * Parse Short-Form Video Script compact brief into schema JSON.
 * Usage: node scripts/parse-short-form-video-brief.mjs [path-to-brief.txt]
 */
...
const briefPath =
  ...
  path.join(
    ...
    ".grok/sessions/F%3A%5Ccreatornivo/019f505d-6680-70f1-adb8-cb5fadaff5be/prompts/prompt_24.txt",
  );
